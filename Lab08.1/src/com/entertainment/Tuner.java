 ...
 */
class Tuner {
    private String channel = "Menu";  //default value is "Menu" if the client doesn't specify
    private int station;  // internal tuner frequency for the named channel

    public void setChannel(String channel) {
        this.channel = channel;
        findStation(channel);  //converts String channel to frequency for the named channel
        goToStation();  //goes to the channel
    }
