...
public class Television {
    ...
    final private Tuner tuner = new Tuner(); //instantiated internally, NOT exposed (private) - no getter or setter - for internal use only
    ...
    public void changeChannel (String channel){
        //delegate to the tuner for the actual work
        tuner.setChannel(channel);
    }

    public String getCurrentChannel(){
        //delegate to the tuner (returns a String)
